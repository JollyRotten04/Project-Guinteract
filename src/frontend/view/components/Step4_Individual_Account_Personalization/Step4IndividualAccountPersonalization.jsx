...
export default function Step4IndividualAccountPersonalization({ allSelected, setUserInput, userInput }){
    ...
    //Setter methods...
    useState(() => {
        if(userInput.month != "" && userInput.year != 0 && userInput.day != 0){
            setSelectedDay(prev => prev = userInput.day);
            setSelectedMonth(prev => prev = userInput.month);
            setSelectedYear(prev => prev = userInput.year);
        }
    },[]);
    ...
    const setSelected = (event) => {
        ...
        if (name == 'month') {
            ...
            setSelectedMonth(value); // Changed from event.target.value to value for consistency
            setUserInput((prev) => ({
                ...prev,
                step4: {
                    ...prev.step4,
                    month: value, // Changed from selectedMonth to value to correctly update the state
                }
            }));
        } else if (name == 'day') {
            console.log(name, value);
            ...
            setUserInput((prev) => ({
                ...
                step4: {
                    ...prev.step4,
                    day: value, // Changed from selectedDay to value to correctly update the state
                }
            }));
        } else if (name == 'year') {
            console.log(name, value);
            ...
            setUserInput((prev) => ({
                ...
                step4: {
                    ...prev.step4,
                    year: value, // Changed from selectedYear to value to correctly update the state
                }
            }));
        }
            ...
            <p id="mainLabel">Next, when were you born?</p>
                <div className="dropdownContainers">
                    ...
                    <div id="monthDropdown" className = "custom-select">
                        <select name="month" value={selectedMonth || ""} id="monthDropdown" size={isExpanded ? "5" : "1"} onChange={setSelected}>
                    ...
                    <div id="dayDropdown" className = "custom-select">
                        ...
                        <select name="day" value={selectedDay || ""} id="dayDropdown" size={isExpanded ? "5" : "1"} onChange={setSelected}>
                    ...
                    <div id="yearDropdown" className = "custom-select">
                        <select name="year" value={selectedYear || ""} id="yearDropdown" size = {isExpanded ? "5" : "1"} onChange={setSelected}>
